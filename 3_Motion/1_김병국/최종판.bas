...
전진달리기50_1:
    FOR I = 0 TO 5
        ...
        WAIT
        '---------------------------------
        'MOVE G6D,97,  88, 100, 120, 104
        'MOVE G6A,106, 78, 146,  91, 102
        'MOVE G6C, 80
        'MOVE G6B,120
        'WAIT
        ...
        WAIT
        '---------------------------------
        'MOVE G6D,94,  75, 122, 120, 104
        'MOVE G6A,104, 80, 146,  91, 102
        'WAIT
...
MAIN1:
    ...
    ON A GOTO MAIN1,KEY1,KEY2,KEY3,KEY4,KEY5,KEY6,KEY7,KEY8,KEY9,KEY10,KEY11,KEY12,KEY13,KEY14
    'GOTO KEY34
    'DELAY 500
